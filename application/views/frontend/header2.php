...
<link rel="stylesheet" href="<?php echo base_url();?>assets/frontend/css/flexslider.css" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url();?>assets/frontend/css/dataTables.min.css" type="text/css" media="all" />
<!-- //Custom Theme files -->  
<!-- web-fonts -->   
			...
			<div class="container"> 
				<div class="header-top"><!-- header-top -->
					<div class="agile-hdleft nav navbar-nav navbar-left">
						<ul>  
							<li><a href="mailto:example@mail.com"><i class="fa fa-envelope-o"></i>  sayeemuddin93@gmail.com</a></li>
							<li><i class="fa fa-phone"></i> +8801713804390 </li> 
						</ul> 
					</div>
